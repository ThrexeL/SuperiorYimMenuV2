...
namespace YimMenu
{
	...
	void Menu::SetupStyle()
	{
		...
		style.Colors[ImGuiCol_TextDisabled] = ImVec4(0.55f, 0.55f, 0.75f, 1.00f);

		// Window backgrounds
		style.Colors[ImGuiCol_WindowBg] = ImVec4(0.06f, 0.07f, 0.14f, 1.00f);
		style.Colors[ImGuiCol_ChildBg]  = ImVec4(0.08f, 0.09f, 0.16f, 1.00f);
		style.Colors[ImGuiCol_PopupBg]  = ImVec4(0.04f, 0.05f, 0.10f, 0.95f);

		// Borders and frames
		style.Colors[ImGuiCol_Border]  = ImVec4(0.25f, 0.30f, 0.45f, 0.25f);
		style.Colors[ImGuiCol_FrameBg] = ImVec4(0.14f, 0.18f, 0.28f, 1.00f);
		style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.22f, 0.27f, 0.43f, 1.00f);
		style.Colors[ImGuiCol_FrameBgActive] = ImVec4(0.27f, 0.32f, 0.50f, 1.00f);

		// Buttons
		style.Colors[ImGuiCol_Button] = ImVec4(0.17f, 0.22f, 0.38f, 1.00f);
		style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.22f, 0.28f, 0.48f, 1.00f);
		style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.27f, 0.33f, 0.58f, 1.00f);

		// Title bars
		style.Colors[ImGuiCol_TitleBg]       = ImVec4(0.07f, 0.09f, 0.16f, 1.00f);
		style.Colors[ImGuiCol_TitleBgActive] = ImVec4(0.12f, 0.14f, 0.24f, 1.00f);
		style.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.05f, 0.06f, 0.12f, 1.00f);

		// Tabs
		style.Colors[ImGuiCol_Tab]        = ImVec4(0.17f, 0.22f, 0.38f, 0.85f);
		style.Colors[ImGuiCol_TabHovered] = ImVec4(0.23f, 0.30f, 0.50f, 0.85f);
		style.Colors[ImGuiCol_TabActive]  = ImVec4(0.28f, 0.35f, 0.60f, 1.00f);

		// Headers
		style.Colors[ImGuiCol_Header]        = ImVec4(0.18f, 0.23f, 0.40f, 1.00f);
		style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.25f, 0.30f, 0.50f, 1.00f);
		style.Colors[ImGuiCol_HeaderActive]  = ImVec4(0.30f, 0.37f, 0.60f, 1.00f);

		// Plots
		style.Colors[ImGuiCol_PlotLines] = ImVec4(0.45f, 0.55f, 0.85f, 1.00f); 
		style.Colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.55f, 0.65f, 0.95f, 1.00f);
		style.Colors[ImGuiCol_PlotHistogram]    = ImVec4(0.45f, 0.55f, 0.85f, 1.00f);
